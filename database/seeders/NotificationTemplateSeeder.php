...
class NotificationTemplateSeeder extends Seeder
{
    ...
    {
        $templates = [
            ['auth.otp', 'Login OTP', ['sms'], '{otp} is your Tractor Sarthi verification code. Valid for {minutes} minutes. Do not share it.', null, null, ['otp', 'minutes']],
            ['user.welcome', 'Welcome', ['sms', 'database'], 'Welcome to Tractor Sarthi, {name}! Buy, sell and finance tractors in one place.', 'Welcome to Tractor Sarthi', null, ['name']],
            ...
            ['lead.assigned.dealer', 'New lead (dealer)', ['sms', 'database'], 'New Tractor Sarthi lead {reference} in {district}. Respond within {sla} minutes.', 'New lead assigned', null, ['reference', 'district', 'sla']],
            ...
            ['loan.disbursed', 'Loan disbursed', ['sms', 'database'], 'Loan {reference} has been disbursed. Thank you for choosing Tractor Sarthi.', 'Loan disbursed', null, ['reference']],
